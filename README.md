...
## Room
총 6종류의 방이 존재: **Main, Regular, Recovery, Lintel, Trap, Treasure**
...
## 기타 기능 (Box Open, Recovery, Stat Upgrade)

### 함정 (HP 감소, Soul 감소, 랜덤 박스)  
...
## 적 (총 4종류: Skeleton, Cthulhu, Flying Head, Ghost)  
